    ...
    <div className="landing-root">
      ...
      <section className="landing-hero" ref={heroRef}>
        <div className="landing-hero-left">
          ...
          <h1 className={`landing-hero-title ${v}`}>
            Salud que se<br />gestiona con <em>precisión</em>
          </h1>
          <p className={`landing-hero-subtitle ${v}`}>
            Plataforma integral para la administración de turnos,
            especialistas y afiliados. Diseñada para la excelencia en la atención médica.
          </p>
        ...
        <div className="landing-hero-right">
          ...
          <div className={`landing-hero-card landing-hero-card-2 ${v}`}>
            ...
            <div className="landing-card-value" style={{ fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
          ...
          <div className={`landing-hero-card landing-hero-card-3 ${v}`}>
            ...
            <div className="landing-card-sub" style={{ display: 'flex', gap: '1rem' }}>
              <span style={{ color: 'var(--color-success)' }}>18 confirmados</span>
      ...
      <section className="landing-features" id="features">
        ...
        <div className="landing-features-visual">
          <div className="landing-features-card-main">
            ...
            <div style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {dashboardItems.map((item) => (
                <div
                  key={item.label}
                  style={{ display: 'flex', justifyContent: 'space-between', padding: '0.6rem 0', borderBottom: '1px solid var(--color-border)' }}
                >
                  <span style={{ fontSize: '0.8rem', color: 'var(--color-muted)' }}>{item.label}</span>
                  <span style={{ fontSize: '0.9rem', color: item.color, fontFamily: 'var(--font-display)' }}>{item.val}</span>
                </div>
              ))}
            </div>
            ...
            <div style={{ marginTop: '0.5rem', fontSize: '0.65rem', color: 'var(--color-muted)' }}>
          ...
          <div className="landing-features-card-accent">
            ...
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.8rem', color: 'var(--color-success)', marginBottom: '0.25rem' }}>
              98%
            </div>
            <div style={{ fontSize: '0.7rem', color: 'var(--color-muted)' }}>Uptime del sistema</div>
          </div>
        </div>
      </section>
      ...
      <section className="landing-cta">
        <h2 className="landing-cta-title">
          ¿Listo para una gestión<br /><em>más inteligente?</em>
        </h2>
      ...
      <footer className="landing-footer">
        ...
        <div className="landing-footer-text">© 2026 — Sistema de gestión médica v2.0</div>
      </footer>
